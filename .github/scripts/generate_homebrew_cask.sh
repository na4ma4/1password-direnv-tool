...
echo "Generating op-direnv.rb cask file..."
...
TARGET_FILENAME="op-direnv.rb"
TARGET_FULLPATH="${TARGET_DIR}/${TARGET_FILENAME}"

if [[ ! -z "${GITHUB_OUTPUT}" ]]; then
  (
    echo "target_name=op-direnv"; 
...
SHA_DARWIN_ARM64="$(sha256sum artifacts/archives/op-direnv_darwin_arm64.tar.gz | awk '{print $1}')"
